...
func pay(rss *sessions.RenterSession, result *escrowpb.SignedSubmitContractResult, fileSize int64, shardIndexes []int, offlineSigning bool, isRenewContract bool) error {
	...
	return doGuard(rss, payinRes, fileSize, shardIndexes, offlineSigning, isRenewContract)
}
